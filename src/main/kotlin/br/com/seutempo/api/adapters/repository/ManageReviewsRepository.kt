...
import br.com.seutempo.api.adapters.repository.jpa.review.ReviewsJpaRepository
...
class ManageReviewsRepository(
    ...
    private val professionalOutputPort: ManageProfessionalOutputPort,
    ...
    override fun findRankByRatingProfessional(): List<RankResponse> {
        val simpleRank = reviewsJpaRepository.findRankByProfessional()
        return simpleRank.map { item ->
            RankResponse(
                professional =
